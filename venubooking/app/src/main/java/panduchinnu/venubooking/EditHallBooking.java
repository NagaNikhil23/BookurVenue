 ...
 * {@link EditHallBooking.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link EditHallBooking#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EditHallBooking extends Fragment {
    ...
    String hallname,owner,cust,date;
    EditText ert2,ert3;
    TextView ert1;
    DatePicker dp1;
    Button b1;
     ...
     * @return A new instance of fragment EditHallBooking.
     */
    // TODO: Rename and change types and number of parameters
    public static EditHallBooking newInstance(String param1, String param2) {
        EditHallBooking fragment = new EditHallBooking();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bookedby=ert3.getText().toString();Toast.makeText(getActivity(),"onclick",Toast.LENGTH_LONG).show();
                Cursor res2=dbcus.getStatusofhall(hallnamee,datee);
                if(res2.getCount()==0){
                    String res=dbcus.insertBooking(hallnamee,datee,bookedby,"Booked",owner);
                    Toast.makeText(getActivity(),""+res,Toast.LENGTH_LONG).show();
                    ert1.setText("");
                    ert2.setText("");
                    ert3.setText("");
                    Fragment frg = new editok();
                    Bundle args=new Bundle();
                ...
                while(res2.moveToNext()){
                    status=res2.getString(0);
                    Toast.makeText(getActivity(),""+status,Toast.LENGTH_LONG).show();
                    if(status.equals("Pending")){
                        String res=dbcus.updateBooking(hallnamee,datee,bookedby,"Booked",owner);
                        Toast.makeText(getActivity(),""+res,Toast.LENGTH_LONG).show();
                        ert1.setText("");
                        ert2.setText("");
                        ert3.setText("");
