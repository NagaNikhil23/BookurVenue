...
public class Rating extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        eett1=(EditText)v.findViewById(R.id.editText9);
        rb1=(RatingBar)v.findViewById(R.id.ratingBar);
        btt=(Button)v.findViewById(R.id.button19);
        btt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ff=(Float)rb1.getRating();
                query=eett1.getText().toString();
                Toast.makeText(getActivity(),""+ff+"\n"+query,Toast.LENGTH_LONG).show();
            }
        });
